...
typedef struct s_samdata
{
    ...
    struct sam
    {
        ...
        unsigned char phonemeIndexOutput[256]; //tab47296 (was 60 - too small, causes overflow crash)
        unsigned char stressOutput[256]; //tab47365
        unsigned char phonemeLengthOutput[256]; //tab47416
    } sam;
} SamData;
